...
# NOTE: the following library dependencies are unknown, ignoring: brcmEGL plist-2 bcm_host vchiq_arm plist vcos openmaxil brcmGLESv2
#       (this is based on recipes that have previously been built and packaged)
DEPENDS = "openssl avahi libplist mdns"
